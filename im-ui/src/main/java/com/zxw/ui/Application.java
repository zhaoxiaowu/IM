...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        chat.addTalkBox(-1, 0, "1000005", "哈尼克兔", "04_50", "你把爱放在我的心里", new Date(), false);
        chat.addTalkBox(-1, 0, "1000006", "哈尼克兔", "04_50", "你把爱放在我的心里", new Date(), false);
        chat.addTalkBox(-1, 0, "1000007", "哈尼克兔", "04_50", "你把爱放在我的心里", new Date(), false);
        chat.addTalkBox(-1, 0, "1000008", "哈尼克兔", "04_50", "你把爱放在我的心里", new Date(), false);
        chat.addTalkBox(-1, 0, "1000009", "哈尼克兔", "04_50", "你把爱放在我的心里", new Date(), false);
